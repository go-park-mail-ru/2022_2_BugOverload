...
// Package mockAuthClient is a generated GoMock package.
...
func (m *MockAuthService) CreateSession(ctx context.Context, user *models.User) (models.Session, error) {
	m.ctrl.T.Helper()
...
func (mr *MockAuthServiceMockRecorder) CreateSession(ctx, user interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateSession", reflect.TypeOf((*MockAuthService)(nil).CreateSession), ctx, user)
}

// DeleteSession mocks base method.
func (m *MockAuthService) DeleteSession(ctx context.Context, session *models.Session) (models.Session, error) {
	m.ctrl.T.Helper()
...
func (mr *MockAuthServiceMockRecorder) DeleteSession(ctx, session interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteSession", reflect.TypeOf((*MockAuthService)(nil).DeleteSession), ctx, session)
}
...
func (m *MockAuthService) GetUserBySession(ctx context.Context, session *models.Session) (models.User, error) {
	m.ctrl.T.Helper()
...
func (mr *MockAuthServiceMockRecorder) GetUserBySession(ctx, session interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetUserBySession", reflect.TypeOf((*MockAuthService)(nil).GetUserBySession), ctx, session)
}
