...
С точки зрения запросов оптимизация уже была проведена.

С точки зрения инструментов в базе (индексы) тоже.

Так что оптимизацию негде провести в первом приближении.
