...
- Важно четко понимать также и объемы потоков чтения и записи, для оптимизации в ту или иную сторону. Условно индексы в чтение помогает, а в запись мешает.
- Меньше запросов - больше профита, денормализация хорошо помогает в этом.
